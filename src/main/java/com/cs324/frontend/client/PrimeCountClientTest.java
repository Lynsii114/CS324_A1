...
/**
 * Manual PRIMECOUNT client. Send the job to the current coordinator worker.
 */
public class PrimeCountClientTest {
    ...
    private static final List<Integer> DEFAULT_NUMBERS =
            Arrays.asList(29, 10, 3, 4, 7, 12, 2, 18, 23, 5, 30, 11, 1, 37, 42, 17, 9, 31, 6, 19);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("[Client] Sending PRIMECOUNT job -> coordinatorId=" + coordinator.getWorkerId()
                + ", numbers=" + numbers);
        int result = coordinator.submitPrimeCount(numbers);
        System.out.println("[Client] PRIMECOUNT result <- " + result);
    }
